...
public class MainUi {
	...
	public static void main(String[] args) throws IOException {
		...
		frame.add(createLabelImage(Ponts.class.getResource("centre ville.jpg"))); //ajouter des composants à la fenêtre
		frame.add(createLabelImage(Villes.class.getResource("le havre.jpg")));
		frame.add(createLabelImage(PanneauRonds.class.getResource("panneau 70.jpg")));
		frame.add(createLabelImage(Panneau.class.getResource("panneaubleu-carre.jpeg")));
		frame.add(createLabelImage(Panneau.class.getResource("parking.jpg")));
		frame.add(createLabelImage(Panneau.class.getResource("route panneau.jpg")));
		frame.add(createLabelImage(Villes.class.getResource("tour eiffel.jpg")));
		frame.add(createLabelImage(Villes.class.getResource("ville espace verts.jpg")));
		frame.add(createLabelImage(Villes.class.getResource("voie pieton.jpg")));
